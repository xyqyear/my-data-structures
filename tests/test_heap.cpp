...
int main(int argc, char const *argv[])
{
    ...
    {
        assert(minHeap.removeFirst() == minHeapSortedArray[i]);
    }
    cout << "finished testing min heap" << endl
         << endl;
    ...
    for (size_t i = 0; i < 8; i++)
    {
        ...
        assert(maxHeap.removeFirst() == maxHeapSortedArray[i]);
    }
    cout << "finished testing max heap" << endl
         << endl;
    ...
    for (size_t i = 0; i < 9; i++)
    {
        ...
        assert(maxHeap1.removeFirst() == insertedHeapArray[i]);
    }
